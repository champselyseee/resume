...
const CONTENT = {
  ...
  ru: {
    ...
    courses: [
      {
        years: "2025",
        place: "Финансовое моделирование в Excel",
        note: "Построение модели с нуля, сценарии, проверка на ошибки.",
        logo: "",
      },
      {
        years: "2025",
    ...
    experience: [
      {
        years: "2025 — н.в.",
        place: "Стартап «Название»",
        note: "Стажёр-аналитик: выгрузки данных, еженедельная отчётность, автоматизация рутинных расчётов в Excel.",
        logo: "",
      },
      {
        years: "2023 — 2024",
        place: "Магазин «Название»",
        note: "Продавец-консультант: касса, приёмка и учёт товара, работа с покупателями и возражениями.",
        logo: "",
      },
    ],
